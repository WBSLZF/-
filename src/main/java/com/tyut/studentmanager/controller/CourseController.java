...
public class CourseController {
    ...
    @ResponseBody
    public Map<String, Object> getClazzList(@RequestParam(value = "page", defaultValue = "1")Integer page,
        ...
        if(!StringUtils.isEmpty(from) && from.equals("combox")){
            return (Map<String, Object>) pageBean.getDatas();
        }else{
